const fs = require('fs');
const dir = 'artifacts/fashion-store/src/components/themes/storefronts';
...
fs.writeFileSync('artifacts/fashion-store/src/components/themes/storefronts/GlowGridStorefront.tsx', componentCode);
