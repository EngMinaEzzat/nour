...
import { ClinicStorefront } from "@/components/themes/storefronts/ClinicStorefront";
...
export default function Storefront({ overrideSlug }: { overrideSlug?: string; params?: { slug?: string } }) {
  ...
  if (storeThemeId === "clinic") {
    return <ClinicStorefront store={store} products={store.products || []} categories={store.categories || []} />;
  }
