        ...
        <div className="theme-glow-grid bg-[#131313] text-[#e5e2e1] min-h-[100dvh] pb-24 md:pb-0 w-full overflow-x-hidden" style={{ fontFamily: 'Spline Sans, sans-serif' }}>
            ...
            <header className="bg-[#201f1f] flex justify-between items-center w-full px-4 md:px-8 py-6 sticky top-0 z-50 border-b border-white/10">
                <div className="flex gap-2 items-center">
                    <button aria-label={t("common.buttons.cart", "Cart")} className="text-[#b9c3ff] font-medium text-sm transition-colors flex items-center justify-center">
                            ...
                            <div className="aspect-[3/4] relative bg-[#201f1f]">
                                ...
                                <div className="absolute bottom-0 left-0 w-full p-6 flex flex-col gap-2">
                                    ...
                                    <div className="flex items-center justify-between mt-2">
                                        ...
                                        <button aria-label={t("common.buttons.addToCart", "Add to Cart")} className="w-10 h-10 rounded-full border border-[#8e8fa3] text-[#b9c3ff] flex items-center justify-center hover:bg-[#313030] transition-colors">
                                            <span aria-hidden="true" className="material-symbols-outlined font-sans font-bold text-sm">+</span>
                                        </button>
                                    </div>
                                </div>
                            </div>
