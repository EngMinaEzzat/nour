...
export function Layout({ children }: { children: ReactNode }) {
  ...
  const isSubscriptionActive = !merchant || merchant.isPlatformAdmin || !merchant.subscriptionStatus || merchant.subscriptionStatus === "active" || (
    ...
    (!("trialEndsAt" in merchant) || !(merchant as unknown as { trialEndsAt?: string | null }).trialEndsAt || new Date((merchant as unknown as { trialEndsAt?: string | null }).trialEndsAt!) > new Date())
  );
