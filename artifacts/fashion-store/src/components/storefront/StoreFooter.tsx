  ...
  const NAV_SECTIONS = [
    {
      ...
      links: [
        {
          label: t("storefront.products.newArrivals"),
          action: () =>
            document
        ...
        {
          label: t("storefront.header.links.bestSellers"),
          action: () =>
            document
        ...
        {
          label: t("storefront.header.links.allProducts"),
          action: onScrollToProducts,
        },
    ...
    },
    {
      ...
      links: [
        ...
        {
          label: t("storefront.footer.contactUs"),
          action: () => waNum && window.open(`https://wa.me/${waNum}`),
        },
      ],
    },
  ];
    ...
    >
      ...
      <div
        style={{
          height: 1,
          background:
            "linear-gradient(to right, transparent, rgba(200,150,58,0.4), transparent)",
        }}
      />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12">
          ...
          <div className="sm:col-span-2 md:col-span-1">
            ...
            {city && (
              <p className="text-xs flex items-center gap-1.5 mb-5">
                ...
                {city}، {t("storefront.footer.egypt")}
              </p>
            )}
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {[
                t("storefront.trust.secure_badge", {
                  defaultValue: "🔒 Secure Payment",
                }),
                t("storefront.trust.shipping_badge", {
                  defaultValue: "📦 Fast Shipping",
                }),
                t("storefront.trust.returns_badge", {
                  defaultValue: "↩️ Free Returns",
                }),
                t("storefront.trust.authentic_badge", {
                  defaultValue: "⭐ 100% Authentic",
                }),
              ].map((badge) => (
                <span
                  key={badge}
        ...
        >
          <span>
            ...
            {t("storefront.footer.allRightsReserved")}
          </span>
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              aria-label={t("storefront.footer.scrollToTop", "Scroll to top")}
            >
