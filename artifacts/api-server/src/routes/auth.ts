    ...
    const result = await db.transaction(async (tx) => {
      const [tenant] = await tx
        ...
        .values({
          ...
          slug,
          description,
          category: category as "fashion" | "cosmetics" | "both" | "clinic",
          theme: category === "cosmetics" ? "cosmetics" : category === "clinic" ? "clinic" : "classic",
          coverUrl: category === "cosmetics" ? "/product-cosmetics.png" : category === "clinic" ? "https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?q=80&w=2053&auto=format&fit=crop" : null,
          primaryColor: category === "cosmetics" ? "#DDA7A5" : category === "clinic" ? "#0066cc" : null,
          secondaryColor: category === "cosmetics" ? "#8A5A58" : category === "clinic" ? "#e6f0fa" : null,
          status: "active",
