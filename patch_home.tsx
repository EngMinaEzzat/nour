  ...
  return (
    <div className="home-theme flex flex-col bg-background text-foreground" dir={i18n.dir()}>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }}>
              <Badge className="mb-6 text-sm px-4 py-1.5 bg-accent/20 text-accent-foreground border-accent/30 rounded-full">
      ...
      <section className="py-24 relative overflow-hidden bg-foreground text-background">
        <video autoPlay loop muted playsInline className="absolute inset-0 w-full h-full object-cover opacity-20 mix-blend-overlay pointer-events-none">
