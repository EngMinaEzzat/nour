    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      ...
      >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                >
                  {t("text_efdc1740", t("text_efdc1740", "نسيت كلمة المرور؟"))}
                                                  </Link>
              </div>
            ...
            >
              {isLoading ? (
                <><Loader2 className="w-4 h-4 ms-2 animate-spin" /> {t("text_1f56129c", t("text_1f56129c", "جارٍ تسجيل الدخول..."))}</>
              ) : (
                <><Store className="w-4 h-4 ms-2" /> {t("text_b5dcde74", t("text_b5dcde74", "تسجيل الدخول"))}</>
              )}
            </Button>
          </form>
        </motion.div>
        ...
        <p className="text-center text-sm text-muted-foreground mt-6">
          {t("text_d9f43b94", t("text_d9f43b94", "ليس لديك حساب؟"))}{" "}
          <Link href="/register" className="text-primary font-semibold hover:underline">
            {t("text_e65ce1d3", t("text_e65ce1d3", "سجّل متجرك الآن"))}
                                </Link>
        </p>
      </motion.div>
    </div>
