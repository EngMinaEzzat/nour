...
const PIXELS = [
  {
    ...
    hint: t("text_0be0b275", "مثال: G-ABC123XYZ"),
  ...
  },
  {
    ...
    hint: t("text_6a1cc421", "10-20 رقم فقط"),
  ...
  },
  {
    ...
    hint: t("text_d0e8921d", "سلسلة أحرف وأرقام"),
  ...
  },
  {
    ...
    hint: t("text_1e8b6ea7", "مثال: AW-123456789"),
  ...
  return (
    <div className="space-y-6" dir="rtl">
      <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}>
        <h1 className="text-2xl font-bold text-gray-900">{t("text_ad2ce802", t("text_ad2ce802", "بيكسلات التتبع"))}</h1>
        <p className="text-gray-500 mt-1">{t("text_e6e410b2", t("text_e6e410b2", "تتبع أداء متجرك وحملاتك التسويقية"))}</p>
      </motion.div>
        ...
        <>
                ...
                <motion.div key={pixel.key} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.05 }}
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      dir="ltr"
                    />
                    <p className="text-xs text-gray-500">{pixel.hint} • <a href={pixel.docs} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">{t("text_1d794247", t("text_1d794247", "كيفية الحصول عليه"))}</a></p>
                  </div>
                  {isEnabled && idValue && (
                    <div className="mt-3 flex items-center gap-1 text-xs text-green-700">
                      <CheckCircle className="w-3 h-3" /> {t("text_4759637e", t("text_4759637e", "مفعّل"))}
                                                  </div>
                  )}
                </motion.div>
              );
          ...
          {saved && (
            <motion.div initial={{ opacity: 0, y: -5 }} animate={{ opacity: 1, y: 0 }}
              ...
              <CheckCircle className="w-5 h-5 shrink-0" /> {t("text_2388ac6b", t("text_2388ac6b", "تم حفظ إعدادات التتبع بنجاح"))}
                                          </motion.div>
          )}
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.25 }} className="flex justify-end">
            <button onClick={() => saveMutation.mutate()} disabled={saveMutation.isPending}
              ...
              {saveMutation.isPending ? t("text_c41cc0ec", "جاري الحفظ...") : t("text_32be3bad", "حفظ الإعدادات")}
            </button>
          </motion.div>
        </>
      )}
