    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-end justify-between mb-10">
          <div>
            <p
              ...
              style={{ color: p }}
            >
              {t("text_47dba725", t("text_47dba725", "المفضلة دائماً"))}
                                      </p>
            <h2
              className="text-4xl md:text-5xl text-stone-900"
              style={{ fontFamily: SERIF, fontWeight: 400 }}
            >
              {t("text_b428ed77", t("text_b428ed77", "الأكثر"))}
                                        <br />
              <span style={{ color: p, fontStyle: "italic" }}>{t("text_92d49e49", t("text_92d49e49", "مبيعاً"))}</span>
            </h2>
          </div>
          <button
            ...
            style={{ color: p }}
          >
            {t("text_1eab5c6c", t("text_1eab5c6c", "عرض الكل"))}
        ...
        <div className="mt-10 text-center md:hidden">
          ...
          >
            {t("text_a4b8809f", t("text_a4b8809f", "عرض كل المنتجات"))}
                                </button>
        </div>
      </div>
    </section>
