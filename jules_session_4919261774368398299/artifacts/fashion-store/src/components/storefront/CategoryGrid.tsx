        ...
        <div className="flex items-end justify-between mb-10">
          <div>
            <p
              ...
              style={{ color: p }}
            >
              {t("text_0d699450", t("text_0d699450", "تسوقي بالفئة"))}
                                      </p>
            <h2
              className="text-4xl md:text-5xl text-stone-900"
              style={{ fontFamily: SERIF, fontWeight: 400 }}
            >
              {t("text_0a8516b0", t("text_0a8516b0", "اكتشفي مجموعتنا"))}
                                      </h2>
          </div>
          <button
            ...
            style={{ color: p }}
          >
            {t("text_2495fa54", t("text_2495fa54", "كل المنتجات"))}
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4">
                  <p className="text-white/60 text-[10px] tracking-widest uppercase mb-0.5 font-medium">
                    {category.productCount ?? 0} {t("text_bb7632a2", t("text_bb7632a2", "منتج"))}
                                              </p>
                  <h3
                  ...
                  <div
                    ...
                    style={{ color: accent }}
                  >
                    {t("text_173c1551", t("text_173c1551", "تسوقي الآن"))}
