...
const STEPS: Step[] = [
  {
    ...
    step: "01",
    title: t("text_fd83a270", "التنظيف"),
    desc: t("text_56319e9e", "ابدئي روتينك بتنظيف بشرتك بلطف لإزالة الشوائب وإعداد بشرتك للعناية التالية."),
    color: "#8B1A35",
  ...
  },
  {
    ...
    step: "02",
    title: t("text_9c9f1ae6", "الترطيب"),
    desc: t("text_d7a3cdbf", "رطّبي بشرتك بسيروم مغذٍّ يمنحها نضارة دائمة ويحافظ على توازنها الطبيعي."),
    color: "#c97b8b",
  ...
  },
  {
    ...
    step: "03",
    title: t("text_3e2d53b3", "الحماية"),
    desc: t("text_36ecf78b", "احمِي بشرتك من أشعة الشمس يومياً بواقٍ شمسي مناسب لنوع بشرتك."),
    color: "#c8963a",
  ...
  },
  {
    ...
    step: "04",
    title: t("text_81f08518", "العناية الليلية"),
    desc: t("text_02502d9f", "دعي بشرتك تتجدد أثناء النوم بكريم ليلي مُركَّز يُعيد إليها حيويتها."),
    color: "#7a5c9e",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-14">
          <p
            ...
            style={{ color: p }}
          >
            {t("text_13a50711", t("text_13a50711", "روتين العناية"))}
                                </p>
          <h2
            className="text-4xl md:text-5xl text-stone-900 mb-4"
            style={{ fontFamily: SERIF, fontWeight: 400 }}
          >
            {t("text_04301ba9", t("text_04301ba9", "روتينك اليومي"))}
                                  <br />
            <span style={{ color: p, fontStyle: "italic" }}>{t("text_295a292a", t("text_295a292a", "المثالي"))}</span>
          </h2>
          <p className="text-stone-500 text-[15px] max-w-md mx-auto leading-relaxed">
            {t("text_27c52287", t("text_27c52287", "أربع خطوات بسيطة لبشرة صافية ومشرقة طوال اليوم"))}
                                </p>
        </div>
        ...
        >
          ...
          >
            ...
            {t("text_44099205", t("text_44099205", "تسوقي منتجات العناية"))}
                                </button>
        </motion.div>
      </div>
    </section>
