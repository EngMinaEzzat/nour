        ...
        >
          ...
          <div className={`relative z-10 px-8 py-6 w-full text-${align}`}>
            ...
            <h2 className="text-white text-xl font-bold mb-2 leading-tight" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
              {section.content.heading ?? t("text_a8ec5dcf", "العنوان الرئيسي")}
            </h2>
            <p className="text-white/80 text-xs mb-4">{section.content.subheading ?? t("text_c7ee70a8", "النص التوضيحي")}</p>
            <div className={`flex gap-2 ${align === "center" ? "justify-center" : align === "left" ? "justify-end" : "justify-start"}`}>
              ...
              >
                {section.content.ctaText ?? t("text_173c1551", "تسوقي الآن")}
              </span>
              <span
              ...
              >
                {t("text_dea518d5", t("text_dea518d5", "وصل حديثاً"))}
                                        </span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white px-6 py-8">
          <div className="flex items-center gap-3 mb-5">
            <div>
              ...
              <h3 className="text-lg font-semibold text-stone-900" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
                {section.content.heading ?? t("text_20bb33c8", "جميع المنتجات")}
              </h3>
            </div>
            <div className="flex-1 h-px bg-stone-100" />
            <span className="text-[10px] text-stone-400">{t("text_c6e2f3c9", t("text_c6e2f3c9", "منتجات المتجر"))}</span>
          </div>
          <div className="flex gap-2 mb-4">
            {[t("text_6d08f196", "الكل"), t("text_2f56c4c3", "أزياء"), t("text_9074344a", "جمال"), t("text_32742343", "عطور")].map((label, i) => (
      ...
      return wrap(
        <div className="bg-white px-6 py-8">
          <h3 className="text-center text-lg font-semibold text-stone-900 mb-6" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
            {section.content.heading ?? t("text_c6386f9c", "الأقسام")}
          </h3>
          {previewCategories.length > 0 ? (
            ...
            <div className="rounded-xl border border-dashed border-stone-200 py-6 text-center text-xs text-stone-400">
              {t("text_95d730ef", t("text_95d730ef", "أضيفي الفئات من تبويب الفئات لتظهر هنا"))}
                                      </div>
          )}
          <div className="hidden">
            {[t("text_2f56c4c3", "أزياء"), t("text_a57ee043", "عناية"), t("text_99e81826", "إكسسوار"), t("text_32742343", "عطور")].map((cat, i) => (
      ...
      return wrap(
        <div className="px-6 py-8 text-center text-white relative overflow-hidden" style={{ background: `linear-gradient(135deg, ${p}, ${sec})` }}>
          ...
          <p className="text-2xl font-bold mb-1" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
            {section.content.heading ?? t("text_470bee56", "خصم 30%")}
          </p>
          ...
          >
            {section.content.ctaText ?? t("text_fcc1b0ef", "احصلي على العرض")}
          </span>
        </div>
      );
    }
      ...
      return wrap(
        <div className="bg-white px-6 py-8">
          <div className="grid grid-cols-2 gap-6 items-center">
            ...
            <div>
              <p className="text-[10px] tracking-widest uppercase mb-2" style={{ color: p }}>{t("text_bfb6c2c7", t("text_bfb6c2c7", "قصتنا"))}</p>
        ...
        <div className="py-10 px-6 text-center" style={{ background: `${p}0a` }}>
          ...
          <div className="flex max-w-xs mx-auto gap-2">
            ...
            <span
              ...
              style={{ background: p, borderRadius: theme.buttonStyle === "pill" ? 999 : theme.buttonStyle === "rounded" ? 6 : 0 }}
            >
              {t("text_5fa5780c", t("text_5fa5780c", "اشتركي"))}
                                  </span>
          </div>
        </div>
      );
      ...
      return wrap(
        <div className="bg-[#faf7f4] px-6 py-8 text-center">
          ...
          <span className="bg-green-500 text-white text-xs px-5 py-2 rounded-full font-medium inline-block">
            {section.content.ctaText ?? t("text_d33a45e0", "تواصلي عبر واتساب")}
          </span>
        </div>
      );
    }
