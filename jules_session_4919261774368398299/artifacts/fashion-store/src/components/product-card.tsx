        ...
        <div className="relative aspect-[3/4] overflow-hidden bg-muted">
          ...
          {!unavailable && (
            <button
              ...
              aria-label={product.hasVariants ? t("text_d9a96fc6", "اختر الخيارات") : inCart ? "Added to bag" : "Add to bag"}
            >
              {product.hasVariants ? (
        ...
        <CardContent className="p-4 flex-1 flex flex-col">
          ...
          {product.hasVariants && (
            <p className="text-xs text-muted-foreground mt-1.5 flex items-center gap-1">
              <Layers className="w-3 h-3" /> {t("text_7d7da3d3", t("text_7d7da3d3", "متعدد الخيارات — اختر للإضافة"))}
                                      </p>
          )}
        </CardContent>
      </Card>
