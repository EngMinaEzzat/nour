...
export const GetStorefrontResponse = zod.object({
  ...
  category: zod.enum(["fashion", "cosmetics", "clinic", "electronics", "bistro", "spare_parts", "both"]),
  status: zod.string(),
  ...
  categories: zod.array(
    zod.object({
      ...
      type: zod.enum(["fashion", "cosmetics", "clinic", "electronics", "bistro", "spare_parts"]).optional(),
      imageUrl: zod.string().nullish(),
...
export const registerMerchantBodyPhoneMin = 11;
export const registerMerchantBodyPhoneMax = 11;

export const registerMerchantBodyPhoneRegExp = new RegExp("^01[0125][0-9]{8}$");
...
export const RegisterMerchantBody = zod.object({
  ...
  password: zod.string(),
  category: zod
    .enum(["fashion", "cosmetics", "clinic", "electronics", "bistro", "spare_parts", "both"])
...
export const UpdateTenantBody = zod.object({
  ...
  secondaryColor: zod.string().nullish(),
  theme: zod.string().optional(),
  category: zod.enum(["fashion", "cosmetics", "clinic", "electronics", "bistro", "spare_parts", "both"]).optional(),
...
export const ListCategoriesResponseItem = zod.object({
  ...
  type: zod.enum(["fashion", "cosmetics", "clinic", "electronics", "bistro", "spare_parts"]),
  imageUrl: zod.string().nullish(),
...
export const ListProductsQueryParams = zod.object({
  ...
  hasVariants: zod.coerce.boolean().optional(),
});
...
export const ListOrdersQueryParams = zod.object({
  ...
  hasFailedContact: zod.coerce.boolean().optional(),
